...
def initializeSoftLayerAPI():
    ...
    parser = argparse.ArgumentParser(description="This script is used to untrunk existing VLANs from a host.   This is often used to associate VLANs to a hypervisor host.")
