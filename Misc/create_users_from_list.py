...
print ("getUsers")
result= client['Account'].getUsers()
print (json.dumps(result,indent=2))

print ("User_Permission_Role")
result= client['User_Permission_Role'].getObject(id="901514")
print (json.dumps(result,indent=2))

print ("getPermissionGroups()")
result= client['Account'].getPermissionGroups()
print (json.dumps(result,indent=2))

print ("User_Permission_Group")
result= client['User_Permission_Group'].getObject(id="2385306")
print (json.dumps(result,indent=2))

quit()

## Prompt user forFile to use
userlist=input("Filename of users to create: ")
